...
if(isset($_POST["submit"])){
    ...
    $name = $_FILES['itemImage']['name'][0];
    $size = $_FILES['itemImage']['size'][0];
    $type = $_FILES['itemImage']['type'][0];
    $temp_name = $_FILES['itemImage']['tmp_name'][0];

    $name = $_FILES['itemImage']['name'][1];
    $size = $_FILES['itemImage']['size'][1];
    $type = $_FILES['itemImage']['type'][1];
    $temp_name = $_FILES['itemImage']['tmp_name'][1];
    ...
    $query = "INSERT INTO products(name,price,categoryname,productimage,description,image_2)";
    $query .="VALUES ('$productname',$price,'$categories','$name[0]', '$description', '$name[1]')";
      //Handle other code here'$name[0]'
