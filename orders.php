                        ...
                        <li>
                         <a href="#"><i class="fa fa-table fa-fw"></i> Orders<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="delivered.php">Cleared Orders</a>
                                </li>
                               </ul>
                         </li>
                       <li>
...
// set table headers
echo "<thead><th>ID</th><th>COURSE</th><th>TITLE</th><th>PAGES</th><th>DEADLINE</th><th>FEE</th><th>ACCEPT</th></thead>";
...
echo "<td><a href='order.php?id=" . $row->orderId . "'>". $row->orderId .  "</td>";
echo "<td>" . $row->orderCourse . "</td>";
echo "<td>" . $row->orderTitle . "</td>";
echo "<td>" . $row->pages . "</td>";
echo "<td>" . $row->deadline . "</td>";
echo "<td>" . $row->fee . "</td>";
echo "<td><a href='order.php?id=" . $row->orderId . "'>"?><i class="fa fa-check" aria-hidden="true"></i></a></td>
</a></td>
<?php
echo "</tr>";
}
