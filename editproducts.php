                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="editproducts.php">Edit Categories</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
...
if ($result = $connection->query("SELECT * FROM products ORDER BY id"))
{
...
// set table headers
echo "<thead><th>NAME</th><th>DESCRIPTION</th><th>CATEGORY</th><th>PRICE</th><th>EDIT</th><th>DELETE</th></thead>";
...
echo "<td><a href='editproduct.php?id=" . $row->id . "'>"?><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
<?php echo "<td><a href='delete.php?id=" . $row->id . "'>"?><i class="fa fa-trash" aria-hidden="true"></i>
</a></td>
<?php
echo "</tr>";
}
