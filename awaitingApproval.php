...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Orders for revision</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
if ($result = $connection->query("
    SELECT * FROM orders WHERE writersId ='$writersId ' && assignmentStatus=1;"))
{
...
echo "<td><a href='awaitingApprovalDetails.php?orderId=" . $row->orderId . "'>". $row->orderId .  "</td>";
