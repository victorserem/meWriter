...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Orders in Progress</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                ...
                if ($result = $connection->query("SELECT * FROM orders WHERE writersId ='$writersId ' && assignmentStatus=0;")){
                    if ($result->num_rows > 0){    
                        echo "<thead><th>ID</th><th>COURSE</th><th>TITLE</th><th>PAGES</th><th>DEADLINE</th><th>FEE</th></thead>";
                        while ($row = $result->fetch_object()){
                            echo "<tr>";
                            echo "<td><a href='pendingOrderDetails.php?orderId=" . $row->orderId . "'>". $row->orderId .  "</td>";
