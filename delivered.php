...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cleared Orders</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
if ($result = $connection->query("
    SELECT orders.*, order_items.*, products.*, users.*
    FROM order_items
    INNER JOIN orders
    ...
    INNER JOIN users
    ON order_items.userid = users.userID
...
// set table headers
echo "<thead><th>PRODUCT</th><th>QUANTITY</th><th>USER NAME</th><th>PHONE NUMBER</th><th>ADDRESS</th><th>PRICE</th></thead>";
