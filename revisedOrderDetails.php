...
<head>
    ...
    <link href="vendor/font-awesome/css/collapsible.css" rel="stylesheet" type="text/css">
...
while($row = mysqli_fetch_assoc($result))
{
 ...
 if($commentStatus==0){
echo '<button class="accordion" style="background-color:#A9A9A9" onclick="readComment()">'.$commentSubject.'</button>';
}
else{
	echo '<button class="accordion">'.$commentSubject.'</button>';
}
echo'
...
con.connect(function(err) {
  ...
  var sql = "UPDATE comments SET commentStatus = 1 WHERE commentId='comId'";
