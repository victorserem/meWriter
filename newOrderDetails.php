                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                $sql = "SELECT * FROM answerFiles WHERE orderId='$id'";
                                    ...
                                    ?>
                                <p><?php echo '<a href="downloadFile.php?fileName=' . $row ['fileName']. '">' .$fileName; }}?></p>
                                </div>
                               <?php echo '<a href="acceptOrder.php?id=' . $id. '">';?><input type="button" id="approveButton" class="btn btn-default" value="Accept Order" onclick="alert('Order Accepted.\n Kindly Wait for Administrator Approval');"/>
                            </div>
